node--21166.tpl.php<img src="/sites/default/files/field/image/node_21166.jpg" width="100%" height="auto" style="box-shadow: rgba(0, 0, 0, 0.15) 0px 1px 6px, rgba(0, 0, 0, 0.157) 0px 1px 5px;">
...
<section class="kargah-sec">
    ...
    <div style="width: 70%; background-color: #ffffff; padding: 10px; margin: -4px auto 60px auto; border: solid #b39dd9; border-width: 0px 3px; box-shadow: rgba(0, 0, 0, 0.117647) 0px 1px 6px, rgba(0, 0, 0, 0.117647) 0px 1px 4px; text-align: center;">
    ...
    <div class="first-row" style="margin-top: 40px;">
        <div>
            ...
            <ul>
                <li>ارائه License کوتاه مدت نرم افزارهای SeismoSoft به صورت رایگان به شرکت کنندگان</li>
                <li>
                    اعطای گواهینامه مبتنی بر بلاک چین از موسسه 808 به عنوان نماینده رسمی SeismoSoft در ایران
                </li>
                <a href="https://www.credential.net/ba6tstyu" style="margin-top: 9px;" class="btn" target="_blank"> مشاهده نمونه گواهینامه </a>
    ...
    text-align: justify;">
        <ol style="margin: 0;">
            ...
            <li>
                ...
                <a href="https://civil808.com/node/20167" target="_blank">کلیک کنید.</a>
            </li>
            <li>
                برای مشاهده مجموعه تصاوير دوره سوم آموزش اصول محاسبات لرزه‌ای و طراحی عملکردی سازه‌ها، 8 و 9 اسفند ماه 97 در محل دفتر موسسه 808،
                <a href="https://civil808.com/node/21120" target="_blank">کلیک کنید.</a>
            </li>
        </ol>
    </div>
</section>
