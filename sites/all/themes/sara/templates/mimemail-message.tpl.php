...
<html>
  ...
  <body id="mimemail-body" <?php if ($module && $key): print 'class="'. $module .'-'. $key .'"'; endif; ?>>
    <div id="center">
        ...
        <?php print $body; ?>
            <div id="tabligh">
                <a class="aaa" href="https://civil808.com/cooperate" target="_blank">همکاری با ما</a>
                <a id="aaa2" class="aaa" href="https://civil808.com/question/list" target="_blank"> پرسش و پاسخ </a>
                <a id="aaa3" class="aaa" href="https://civil808.com/landing/advisor" target="_blank">ارتباط با مشاوران</a>
				<a id="aaa4" class="aaa" href="https://civil808.com/pedia" target="_blank">دانشنامه 808</a>
				<a id="aaa6" class="aaa" href="https://civil808.com/app" target="_blank"> اپلیکیشن 808 پلاس </a>
                <a id="aaa5" class="aaa" href="https://civil808.com/node/2" target="_blank"> درباره ما </a>
            </div>
		</div>
		<div id="footer-mail">
      <div class="first-row">
