...
<section id="ebooks" class="product-node">
    ...
    <div class="owl-carousel">
        <?php
        $nids = array( 5552 , 11160 , 5532 , 5533 , 13647);
        $view_mode = 'teaser';
        foreach ($nids as $nid){
            $node = node_load($nid);
            print '<div class="row">';
...
<section id="ebooks">
    ...
    <div class="owl-carousel">
        ...
        <div class="row">
            <a href="/node/8424" target="_blank">
                <img src="/sites/default/files/styles/uc_product/public/field/image/node_8424.jpg?itok=W2JMheNU" width="300" height="170" alt="              برنامه های عمرانی ماشین حساب+ماشین حساب کاسیو الجبرا و کلاسپد (ویژه آزمون محاسبات ورود به حرفه ؛ مهندسین محاسب و دانشجویان)            " title="              برنامه های عمرانی ماشین حساب+ماشین حساب کاسیو الجبرا و کلاسپد (ویژه آزمون محاسبات ورود به حرفه ؛ مهندسین محاسب و دانشجویان)            ">
            </a>
            <a href="/node/8424" target="_blank" class="title">
                برنامه های عمرانی ماشین حساب+ماشین حساب کاسیو الجبرا و کلاسپد (ویژه آزمون محاسبات ورود به حرفه ؛ مهندسین محاسب و دانشجویان)
            </a>
        </div>
        <div class="row">
