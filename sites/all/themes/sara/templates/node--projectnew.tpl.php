...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="header">
    ...
    <?php //print_r($node) ?>
      ...
      <span class="budget"><label><?=t('Project budget')?></label>: <?=$node->field_price_rangenew['und'][0]['value']?></span>
    </div>
    <div class="c2">
    <?php 
      $end = $node->field_active_timenew['und'][0]['value'] * 24 * 60 * 60 + $node->created;
      if(time() < $end) {
