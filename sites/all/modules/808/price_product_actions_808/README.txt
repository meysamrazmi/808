Description
===========
Ubercart Product Actions 808 provides a set of Drupal Actions for usage by Ubercart
...
- Modify product sell price based on list price
- Modify product list price based on sell price
...
If you have any problems/questions/ideas - please contact me and let
me know: m.razmi.92@gmail.com

Authors
=======
Thanks to module "Ubercart Product Actions" Authors:
