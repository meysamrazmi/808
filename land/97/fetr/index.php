...
<html lang="fa" dir="rtl">
	<head>
		...
		<meta property="og:title" content="جشنواره فروش ویژه عید فطر سیویل 808">
		<meta property="og:type" content="website">
		<meta property="og:description" content="جشنواره فروش ویژه عید فطر سیویل 808">
	...
	<body data-gr-c-s-loaded="true">
		...
		<ul class="navigat">
			...
			<li to-id="software"><span>نرم افزارهای 808</span></li>
			<li to-id="college"><span>دوره های ویژه ترم تابستان</span></li>
			<li to-id="aplication"><span>آپدیت جدید پادکست های 808</span></li>
		...
		<section class="panel main" id="intro">
			<div class="inner">
				<header data-aos="fade-up" data-aos-delay="400">
					...
					<p style="font-size: 15px;color: #888;">به علاوه رونمایی از قابلیت جدید اپلیکیشن 808 پلاس</p>
				</header>
		...
		<div id="intro-down" style="background: #f5f5f5;padding:70px 5px;text-align: center;">
            <div data-aos="fade-up">
                <p class="desc"> تا <span><span>%</span><span>40</span></span>
                    تخفیف ویژه نرم افزارهای عمران و معماری
                </p>
        ...
        <section id="software" data-aos="fade-up">
            ...
            <div class="softwate-text">
                ...
                <div class="softwate-text1 with-seprater">
                    <p>
                        از فروشگاه محصولات 808 دانلودی و پستی
                    </p>
                    <p>
                        تا 40% تخفیف
                ...
                <div class="softwate-text1">
                    <p>
                        خرید محتوا با امکان خرید دانلودی نرم افزار
                    </p>
                    <p>
                        تا 20% تخفیف
                    </p>
        ...
        <section id="aplication">
            <div class="wh">
                <h2 data-aos="zoom-in-up" data-aos-delay="400" class="aos-init"> پادکست های رادیو 808 را از اپلیکیشن بشنوید </h2>
