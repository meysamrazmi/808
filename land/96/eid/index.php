...
<html lang="fa" dir="rtl">
	...
	<body data-gr-c-s-loaded="true">
		<ul class="navigat">
			...
			<li to-id="section1"><span>فروش ویژه محصولات تولیدی</span></li>
			<li to-id="featured-product"><span>صفر تا صد محاسبات ساختمان</span></li>
			<li to-id="shop"><span>فروشگاه</span></li>
			<li to-id="footer"><span>پایین صفحه</span></li>
		</ul>
		<section id="intro">
			<div class="cover">
				<span class="tamdid" style="position: fixed;z-index: 1000;color: #fff;background: #F44336;right: calc(50% - 240px);font-family: lalezar;font-size: 3rem;padding: 10px 50px;border-radius: 0 0 30px 30px;border: 7px solid #fff;border-top: 0;border-bottom: 0;"  data-aos="zoom-out" data-aos-delay="3000" >تا 4 فروردین ماه تمدید شد :)</span>
				...
				<div class="box">
					...
					<p data-aos="zoom-in-up" data-aos-delay="700">ویژه نوروز 96</p>
				</div>
				<div class="sale-items">
					<div data-aos="fade-right" data-aos-delay="1000"><span>فروش ویژه محصولات تولیدی</span></div>
					<div data-aos="fade-right" data-aos-delay="1400"><span>هدیه ویژه</span></div>
					<div data-aos="fade-right" data-aos-delay="1800"><span>کارت تخفیف</span></div>
					<div data-aos="fade-right" data-aos-delay="2200"><span>20 درصد تخفیف</span></div>
					<div data-aos="fade-right" data-aos-delay="2600"><span>محصول ویژه</span></div>
				</div>
				<a href="#section1" class="scroll" data-aos="zoom-out" data-aos-delay="3000" data-aos-anchor-placement="top-bottom"></a>
			</div>
		</section>
		...
		<section id="section1" class="panel">
				...
				<h2 data-aos="fade-right">فروش ویژه محصولات تولیدی</h2> 
				<div class="contain">
				...
				<div class="contain profit">
					...
					<div class="right" data-aos="fade-up">
						<span class="hexa">
							<span style="font-size: 50px;height: 40px;display: inline-block;vertical-align: top;line-height: 45px;z-index: 1;position: relative;">40</span>
							<span style="font-size: 20px;vertical-align: top;line-height: 20px;z-index: 1;position: relative;  letter-spacing: 0;">%</span>
						</span>
						<p class="section-title">40 درصد تخفیف ویژه</p>
						<p class="section-desc">تا 40 درصد تخفیف ویژه نوروز 96 </p>
					</div>
					<span class="seperator" data-aos="fade-up"></span>
					<div class="left" data-aos="fade-up">
						...
						<p class="section-title">کارت تخفیف 30 درصدی</p>
						<p class="section-desc">بدون محدودیت مبلغ به مدت 3 ماه برای تمامی محصولات و دوره ها</p>
					</div>
					<span class="seperator" data-aos="fade-up"></span>
					...
					<span class="seperator" data-aos="fade-up"></span>
					<div class="left gift" data-aos="fade-up">
						<p class="section-title">هدیه ویژه</p>
						<p class="section-desc">به همراه یک هدیه ویژه به عنوان عیدی از طرف 808</p>
					</div>
				</div>				
		</section>

		<section class="panel support" data-aos="zoom-out">
			<div>
		...
		<section id="featured-product" class="panel product">
			...
			<h2 data-aos="fade-right">پکیج صفر تا صد محاسبات ساختمان</h2>
		...
		<section id="shop" class="panel shop-main">
			<span class="bookmark" data-aos="fade-down" data-aos-delay="900">تا 20 درصد<br> تخفیف</span>
			<div class="pane-content">
				<span class="num" data-aos="fa de-right">3</span>
			...
			<div>
				...
				<div id="button-wrapper">
					<input type="submit" id="edit-submit-taxonomy-term" value="جستجو">  
				</div>
			</div>
			</form>
		</section>
