...
<html lang="fa" dir="rtl">
	...
	<body data-gr-c-s-loaded="true">
		<ul class="navigat">
			...
			<li to-id="profile-features"><span>مزایای پروفایل</span></li>
			<li to-id="moshaver"><span>آشنایی با مشاوران 808</span></li>
			<li to-id="profile"><span>پکیج 0 تا 100 محاسبات ساختمان</span></li>
		...
		<section class="panel main" id="intro">
			<div class="inner">
				<header data-aos="fade-up" data-aos-delay="400">
					...
					<h1>جشنواره فروش ویژه محصولات 808</h1>
					<p style="font-size: 15px;color: #888;">به علاوه رونمایی از ویژگی های جدید پروفایل کاربری</p>
				</header>
		...
		<div id="intro-down" style="background: #f5f5f5;padding: 35px;text-align: center;">
			...
			<p class="desc" data-aos="fade-up" style="font-family: irans;">و یک ماه عضویت vip به ازای تکمیل پروفایل</p>
		...
		<section id="profile-features" class="panel">
			<h2 data-aos="fade-right" class=""><img src="/96/fetr/images/browser.svg">پروفایل کاربران 808 با امکانات جدید</h2>
			<div class="features" data-aos="zoom-in-up">
				...
				<div class="inteest">
					<img src="/96/fetr/images/bookmark.svg">
					<h3>علاقه مندی ها</h3>
					<p>قابلیت اضافه کردن محتواهای سایت به لیست علاقه مندی های خود</p>
					
				</div>
				<div class="connection">
					<img src="/96/fetr/images/net.svg">
					<h3>ارتباطات بین کاربران</h3>
					<p>قابلیت ایجاد ارتباط با هر یک از کاربران سایت از جمله اساتید و مشاوران 808</p>
					
				</div>
				<div class="vip">
					<img src="/96/fetr/images/vip.svg">
