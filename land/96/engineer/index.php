...
<html lang="fa" dir="rtl">
	...
	<body data-gr-c-s-loaded="true">
		<ul class="navigat">
			...
			<li to-id="latin"><span> رونمایی از سایت لاتین </span></li>
			<li to-id="aplication"><span> رونمایی از اپلیکیشن 808 </span></li>
			<li to-id="pbd"><span> گزارش همایش طراحی عملکردی </span></li>
		...
		<section class="panel main" id="intro">
			<div class="inner">
				<header data-aos="fade-up" data-aos-delay="400">
					...
					<h1>جشنواره فروش ویژه و رونمایی از بخش های جدید 808</h1>
				...
				<div data-aos="zoom-out" data-aos-delay="900" class="aboutus aos-init aos-animate">                 
					<div class="sec-li li">
						<span class="icon-laptop">
							...
							<img src="./images/cellphone2.png" width="530" height="auto" alt="اپلیکیشن اندروید 808 پلاس" title="اپلیکیشن اندروید 808 پلاس">
						</span>
						<div>
							...
							<a class="poster download" href="https://civil808.com/app/src/808plus.apk" target="_self" download="808plus"> دانلود اپلیکیشن اندروید </a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="wh">
				...
				<div data-aos="zoom-out" data-aos-delay="900" class="aboutus aos-init aos-animate">                 
					<div class="sec-li li">
						<span class="icon-laptop">
							<!-- http://land.waterhouse.ir/conf/images/laptop.png -->
							<img src="./images/pbd.jpg" width="530" height="auto" alt="اپلیکیشن اندروید 808 پلاس" title="اپلیکیشن اندروید 808 پلاس">
						</span>
						<div>
