...
<html lang="fa" dir="rtl">
	...
	<body data-gr-c-s-loaded="true">
		<ul class="navigat">
			<li id="main"><span>بالای صفحه</span></li>
			<li id="steps"><span>مراحل</span></li>
			<li id="books"><span>کتاب و فیلم های آموزشی</span></li>
			<li id="eng"><span>آزمون ورود به حرفه</span></li>
			<li id="shop"><span>فروشگاه</span></li>
			<li id="footer"><span>پایین صفحه</span></li>
		</ul>
		<section class="panel main" data-section-name="main" style="height: 634px;">
			<div class="inner">
				<header>
					<h1 data-aos="zoom-in" data-aos-delay="100">جشنواره فروش ویژه دهه فجر سیویل 808</h1>
					<p class="tagline" data-aos="fade-up" data-aos-delay="500">به مناسبت دهه فجر  12 تا 22 بهمن</p>
				</header>
				<p class="desc" data-aos="fade-up" data-aos-delay="700">به همراه <span><span>%</span>20</span> شارژ هدیه به ازای هر تراکنش
					...
					<span style="  font-size: 40px;  display: inline-block;  line-height: 0;  margin: 10px 0 0 0px;  vertical-align: middle;">+</span> ارسال رایگان</p>
				</p>
				<a href="#fajr-section1" class="scroll" data-aos="zoom-out" data-aos-delay="1500" data-aos-anchor-placement="top-bottom"></a>
			</div>
		</section>

		<section class="panel " data-section-name="steps" style="height: 573px;">
			<div id="desc" class="fajr-sections">
				<h2 data-aos="zoom-out">پیشنهاد ویژه کتاب و فیلم های آموزشی</h2> 
				<div class="contain">
					...
					<div data-aos="fade-up" data-aos-delay="2000" data-aos-anchor-placement="top-bottom">
						...
						<p class="section-title"><span>انجام یک تراکنش مالی</span></p>
						<div class="section-desc">
							<p>شما با انجام هر گونه تراکنش مالی اعم از :</p>
							<div>
								<a href="//civil808.com/user/money/charge"  target="_blank">شارژ حساب کاربری</a>
								<a href="#shop" onclick="shopp()">خرید از فروشگاه</a>
								<a href="//civil808.com/college" target="_blank">ثبت نام در دوره ها</a>
							</div>
							<p>بدون هیچ محدودیتی از <span style="  color: #F44336;">20 درصد شارژ هدیه</span> برخوردار شوید</p>
						</div>
					</div>
					<span class="seperator" data-aos="zoom-in" data-aos-delay="200" data-aos-anchor-placement="top-bottom"></span>
					<div class="third" data-aos="fade-up" data-aos-delay="3000" data-aos-anchor-placement="top-bottom">
						<span class="num">3</span>
						<p class="section-title"><span>استفاده از مزایا</span></p>
						<div class="section-desc">
							<p class="titr">ارسال رایگان : <span>محصولات خود را بدون پرداخت هیچ هزینه ارسالی تحویل بگیرید.</span></p>
							<div class="seperator"></div>
							<p class="titr">استفاده از اعتبار : <span>در پرداخت های بعدی خود از اعتبار خود خرج کنید.</span></p>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="panel fajr-section1" data-section-name="books" style="height: 630px;">
			<div id="fajr-section1" class="fajr-sections">
		...
		<section class="panel shop-main" data-section-name="shop" style="height: 310px;">
		...
		<div class="footer non-full-height-section" data-section-name="footer"><a href="http:\\civil808.com" target="_blank" class="footer" data-aos-anchor-placement="top-bottom"> بازگشت به سایت</a></div>
