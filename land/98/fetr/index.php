...
<html lang="fa" dir="rtl">
	<head>
		...
		<title>جشنواره فروش ویژه عید فطر موسسه ۸۰۸</title>
		<meta name="description" content="جشنواره فروش ویژه عید فطر موسسه ۸۰۸">
		<meta name="viewport" content="width=device-width,initial-scale=1">
		<meta property="og:title" content="جشنواره فروش ویژه عید فطر موسسه ۸۰۸">
		<meta property="og:type" content="website">
		<meta property="og:description" content="جشنواره فروش ویژه عید فطر موسسه ۸۰۸">
		<meta property="og:image" content="">
		<meta property="og:url" content="http://land.civil808.com/97/fetr">
		
		<link rel="stylesheet" href="./src/main.css">
		<link rel="stylesheet" href="./src/css/materialdesignicons.css">
		<link rel="stylesheet" href="./src/aos.min.css">
		<link rel="stylesheet" href="./src/flick.css">


        <script src="./src/jquery-2.2.1.min.js"></script>
        <script src="./src/flick.min.js"></script>
        <script src="./src/main.min.js"></script>
        <script src="./src/aos.min.js"></script>
	</head>
	...
	<body data-gr-c-s-loaded="true">
		...
		<ul class="navigat">
			...
			<li to-id="software"><span>کاریابی</span></li>
			<li to-id="college"><span>مجموعه مقالات تحلیلی مرتبط</span></li>
			<li to-id="contact"><span>کارآموزی</span></li>
			<li to-id="work-with-us"><span>کسب درآمد</span></li>
			<li to-id="aplication"><span>اپلیکیشن ۸۰۸ پلاس</span></li>
		...
		<section class="panel main" id="intro">
			<div class="inner" style="display: none">
				<header data-aos="fade-up" data-aos-delay="400">
					<p class="tagline">عید <span>سعید فطر </span> مبارک</p>
					<h1>جشنواره فروش ویژه محصولات ۸۰۸</h1>
					<p style="font-size: 15px;color: #888;">از ۱۰ تا ۱۷ خرداد ماه</p>
				</header>
				<a href="#steps" class="scroll" data-aos="zoom-out" data-aos-delay="1500" data-aos-anchor-placement="top-bottom"></a>
			</div>
		</section>

		<div id="intro-down" style="background: #f5f5f5;padding:70px 5px;text-align: center;">
            <div data-aos="fade-up">
                <p class="desc"> تا <span><span>%</span><span style="font-size: 3rem; letter-spacing: -5px">35</span></span>
                    تخفیف ویژه و اعتبار هدیه:
                </p>
                <p class="desc" style="font-size: 20px;">
                    <i class="mdi mdi-wallet-giftcard red-text"></i>
                    ۲۰٪ اعتبار هدیه</p>
                <p class="desc" style="font-size: 20px;">
                    <i class="mdi mdi-wallet-giftcard red-text"></i>
                    ۱۰٪ تخفیف ویژه کاربران VIP</p>
                <p class="desc" style="font-size: 20px;">
                    <i class="mdi mdi-wallet-giftcard red-text"></i>
                    ۵٪ اعتبار هدیه ویژه اپلیکیشن ۸۰۸ پلاس</p>
                <p>
        ...
        <section class="special-prods">
            <div class="contain profit" style="margin-bottom: 0">
                <div class="contain-header" style="text-align: center;margin: 50px auto">
                    <h3 data-aos="fade-up">به همراه</h3>
                </div>
            </div>

            <div id="festival-prods">
                <div  class="card-holder">
                    <div class="card" data-aos="zoom-in-up">
                        <a href="https://civil808.com/shop/products/fair97/19704/%D9%BE%DA%A9%DB%8C%D8%AC-%D8%A7%D8%B3%D8%AA%D8%AB%D9%86%D8%A7%D8%A6%DB%8C-808">
                            <div class="card-content">
                                <div class="img">
                                    <img src="./images/usb.png" alt="پکیج استثنایی ۸۰۸" width="100%">

                                </div>

                                <div class="content">
                                    <h3>پکیج استثنائی ۸۰۸</h3>
                                    <h4 style="margin-top: -12px;font-size: 12px">حاوی کلیه محتوای رایگان و نیمه رایگان تولید شده توسطه تیم ۸۰۸ طی سالیان اخیر</h4>
                                    <p style="color: #212121">
                                        به همراه یک ماه عضویت VIP در وبسایت ۸۰۸ به صورت رایگان برای خریداران
                                    </p>
                                    <div style="text-align: left">
                                        <span style="position: absolute; right: 35px; color: #212121">همراه با یک فلش ۳۲ گیگ</span>
                                        <span class="new-price" style="padding: 0">۱۰۰ هزار تومان</span>
                                    </div>
                    ...
                    <div class="card"  data-aos="zoom-in-up">
                        <a href="https://civil808.com/landing/vip">
                            <div class="card-content">
                                <div class="img">
                                    <img src="./images/vip.png" alt="VIP یکساله" width="100%">
                                </div>

                                <div class="content">
                                    <h3>۵۰٪ تخفیف عضویت VIP یکساله</h3>
                                    <h4 style="margin-top: -12px;font-size: 12px">ویژه جشنواره پایان سال</h4>
                                    <p style="color: #212121">امکان استفاده از بخشی از محتویات و وبینارها به صورت تماما رایگان
                                        به همراه ۱۰٪ تخفیف دائمی محصولات
                                    </p>
                                    <span class="linethrough">۴۲۰ هزار تومان</span>
                                    <span class="new-price">۲۱۰ هزار تومان</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="card"  data-aos="zoom-in-up">
                        <a href="https://civil808.com/shop/products/ahmadreza-jafari/21534/%D9%BE%DA%A9%DB%8C%D8%AC-%D8%B5%D9%81%D8%B1-%D8%AA%D8%A7-%D8%B5%D8%AF-%D9%85%D8%AD%D8%A7%D8%B3%D8%A8%D8%A7%D8%AA-%D8%B3%D8%A7%D8%AE%D8%AA%D9%85%D8%A7%D9%86-%D8%A7%D8%AD%D9%85%D8%AF%D8%B1%D8%B6%D8%A7-%D8%AC%D8%B9%D9%81%D8%B1%DB%8C">
                            <div class="card-content">
                                <div class="img">
                                    <img src="./images/building.png" alt="پکیج صفر تا صد محاسبات ساختمان" width="100%">
                                </div>

                                <div class="content">
                                    <h3>پکیج صفر تا صد محاسبات ساختمان</h3>
                                    <h4 style="margin-top: -12px;font-size: 12px">مدرس: احمدرضا جعفری</h4>
                                    <p style="color: #212121">
                                        همراه با یک فلش ۳۲ گیگ
                                    </p>
                                    <span class="linethrough"> ۱/۲۲۰ میلیون تومان</span>
                                    <span class="new-price"> ۹۹۹ هزار تومان</span>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="contain profit"  style="margin-top: 80px;text-align: center">
                    <div class="contain-header" style="text-align: center; width: 100%">
                        <h3 class="products" data-aos="fade-up">محصولات ۸۰۸</h3>
                    </div>
                </div>


                <div class="product-catalog" style="margin-bottom: 50px">
                    <div class="card" data-aos="fade-up">
                        <div class="card-content">
                            <div class="img">
                                <img src="./images/catalog.png" alt="کاتالوگ محصولات" width="100%">
                            </div>

                            <div class="content">
                                <h3 class="bold">کاتالوگ محصولات</h3>
                                <h4 style="margin-top: -12px;font-size: 12px">آپدیت بهار ۹۸</h4>
                                <a href="https://civil808.com/sites/default/files/civil808-catalog-spring98.pdf" class="download-catalog">
                                    دانلود کاتالوگ
                                </a>
                                <ul class="product-links">
                                    <li><a href="https://civil808.com/publication">کتاب های الکترونیکی</a></li>
                                    <li><a href="https://civil808.com/article/store">مقالات تحلیلی</a></li>
                                    <li><a href="https://civil808.com/article/software">نرم افزارهای کاربردی</a></li>
                                    <li><a href="https://civil808.com/college">آخرین دوره های آموزشگاه</a></li>
                                    <li><a href="https://civil808.com/store">آخرین فیلم های  فروشگاه</a></li>
                                    <li><a href="https://civil808.com/education">آخرین ورکشاپ های تخصصی</a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <section id="software" data-aos="fade-up">
            ...
            <div class="softwate-text">
                ...
                <p style="text-align: center;	margin-top: 30px;	font-size: 15px;color: #888;">
                    اطلاعات بیشتر را در
                    <a href="https://civil808.com/landing/software" target="_blank" class="title">این صفحه </a>
                    مشاهده کنید
                </p>
            </div>
        </section>
...
<!--                    </a>-->
        ...
        <section id="qa">
            <h2 class="field-label">پرسش و پاسخ</h2>
            <div id="questions" class="node-type-relative">
                <div class="field-items">
                    <div class="question">
                        <div class="reply">
                            <a href="https://civil808.com/node/19306#answer-question" target="_blank"><span>پاسخ به سوال</span></a>
                        </div>

                        <div class="right">
                            <a href="https://civil808.com/user/17235" target="_blank" class="pic" title="Reza.gh"><img src="https://civil808.com/sites/all/themes/sara/images/profile2front.jpg" alt="عکس کاربر"></a>
                            <div class="comment-count">6 پاسخ </div>
                        </div>

                        <div class="left">
                            <a href="https://civil808.com/node/19306" target="_blank" class="q-title"> برای ورود به حرفه به کار عملی در رشته عمران بایست از کجا شروع کنم؟  </a>
                            <div class="body"> سلام.خسته نباشید.من مدرک کارشناسی عمران دارم ولی متاسفانه با هیچکدام از نرم افزارهای مربوط آشنایی ندارم .به رشته ی خودم خیلی علاقمندم ولی توی دانشگاه مطلب خاصی یاد نگرفتم. میخواستم از شما مشاوره بگیرم که از کجا شروع کنم؟البته ارشد هم قبول شدم در رشته مدیریت پروژه ولی علاقه شدیدی به راهسازی دارم.
                                ممنون میشم راهنماییم کنید که چطور و از چه مباحثی باید شروع به یاد گرفتن نرم افزار بکنم.(تقریبا هیچی بلد نیستم بجز اینکه ریاضیات و استاتیک و تحلیل سازه و فولاد حل کنم)
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="question">
                        <div class="reply">
                            <a href="https://civil808.com/node/19684#answer-question" target="_blank"><span>پاسخ به سوال</span></a>
                        </div>

                        <div class="right">
                            <a href="https://civil808.com/user/18083" target="_blank" class="pic" title="hpourzakeri"><img src="https://civil808.com/sites/all/themes/sara/images/profile2front.jpg" alt="عکس کاربر"></a>
                            <div class="comment-count">9 پاسخ </div>
                        </div>

                        <div class="left">
                            <a href="https://civil808.com/node/19684" target="_blank" class="q-title"> برای اینکه سطح علمی خودم رو تو رشته عمران بالاتر ببرم باید چکار کنم؟  </a>
                            <div class="body"> سلام .من یک دانشجو رشته عمران هستم و تقریبا دو ترم دیگه دارم تا مدرک لیسانسم رو بگرم و میخوام در اینده بیشتر توی قسمت طراحی سازه کار کنم و شایدم نقشه کشی ولی اطلاعاتم نسبت کار عمرانی و طراحی سازه کم هست میخواستم راهنماییم کنید ببینم چگونه میتونم اطلاعاتم رو توی این زمینه بیشتر کنم اگر کتابی باید مطالعه کنم و یا کاری باید انجام بدم ممنون میشم راهنماییم کنید همینطور این رو هم بگم که از برنامه اتوکد شروع کردم و میخوام بقیه برنامه ها رو یاد بگیرم مثل ایتبس وسیف و تی ری دی مکس.ممنون میشم اگر راهنماییم کنید که یه جوری سطح علمیم رو بیشتر کنم /و کتاب برای افزایش اطلاعات عمرانی چی پیشنهاد میکنید؟  </div>     </div>
                    </div>

                    <div class="question">
                        <div class="reply">
                            <a href="https://civil808.com/node/21481#answer-question" target="_blank"><span>پاسخ به سوال</span></a>
                        </div>

                        <div class="right">
                            <a href="https://civil808.com/user/24781" target="_blank" class="pic" title="amirfazli"><img src="https://civil808.com/sites/all/themes/sara/images/profile2front.jpg" alt="عکس کاربر"></a>
                            <div class="comment-count">0 پاسخ </div>
                        </div>

                        <div class="left">
                            <a href="https://civil808.com/node/21481" target="_blank" class="q-title"> راهنمای برای ورود به بازار کار  </a>
                            <div class="body"> با سلام به مهندسان عزیز ، بنده دانشجوی ترم 5 عمران در مشهد هستم برای کسب تجربه از شما مهندسان با تجربه به عنوان کاراموزی به صورت رایگان و تمام وقت در خدمت شما هستم ممنون میشم کسی که تجربه و علم خودشو در اختیار من قرار بده  </div>     </div>
                    </div>

                </div></div>
            <div style="text-align: center">
                <a href="http://civil808.com/qa" class="btn btn-blue">ورود به بخش پرسش و پاسخ</a>
            </div>
        </section>
        ...
        <section id="aplication" class="panel">
            <h2  data-aos="zoom-in-up"> اپلیکیشن اندروید ۸۰۸ پلاس </h2>

            <div class="wh"  data-aos="zoom-in-up">
                <div class="aboutus aos-init aos-animate">
                    <div class="sec-li li">
						<span class="icon-laptop">
							<img class="phone" src="https://civil808.com/app/images/10.png" width="530" height="auto" alt="اپلیکیشن اندروید ۸۰۸ پلاس" title="اپلیکیشن اندروید ۸۰۸ پلاس">
						</span>
                        <div>
                            <p>برخی از ویژگی های اپلیکیشن ۸۰۸ پلاس:</p>
                            ...
                            <li>امکان خرید و مطالعه ایبوک های منتشر شده در وبسایت ۸۰۸</li>
                            <li>امکان پخش و دانلود پادکست های وبسایت ۸۰۸</li>
                            <li>امکان مشاهده پروفایل مشاوران و کاربران</li>
                            <li>امکان ایحاد سوال جدید و پاسخ به سوالات موجود در بخش پرسش و پاسخ سایت</li>
                            ...
                            <br>
                            <div style="max-width: 324px;margin-top: 11px;">
                                <a class="poster download googleplay" href="https://play.google.com/store/apps/details?id=com.civil808" target="_target" style="background-image: url(https://civil808.com/app/images/googleplay.png)"></a>
